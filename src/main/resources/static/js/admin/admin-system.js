...
class AdminSystem {
    constructor() {
        ...
        this.FRIENDLY_NAMES = {
            ...
            module_portal_home: 'Strona główna portalu',
            module_student_dashboard: 'Dashboard Studenta',
            ...
            module_community: 'Moduł Społeczność',
            module_wordle: 'Moduł Wordle',
            module_university_calendar: 'Moduł Kalendarza akademickiego',
            module_semester_progress: 'Moduł Postęp semestru',
            module_starosta_dashboard: 'Dashboard Starosty',
