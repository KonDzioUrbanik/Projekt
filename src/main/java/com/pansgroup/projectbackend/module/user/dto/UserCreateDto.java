...
public record UserCreateDto(
                @NotBlank(message = "{user.firstName.notBlank}") @Size(min = 2, max = 30, message = "{user.firstName.size}") String firstName,

                @NotBlank(message = "{user.lastName.notBlank}") @Size(min = 2, max = 30, message = "{user.lastName.size}") String lastName,
